...
namespace PatientRegistryConsole
{
    class Program
    {
        ...
        static List<string> history_patients = new List<string>();
        ...
        static void UpdatePatient()
        {
            ...
            int index = patients.FindIndex(
                p => p.Equals(oldName, StringComparison.OrdinalIgnoreCase));
            ...
            history_patients.Add(oldName);

            // Update current patient
            patients[index] = newName;

            Console.WriteLine(
                $"Success: Updated '{oldName}' → '{newName}'");
        }
